...
const pageDuration = new Trend ('Page_MyAccount_Duration', true)

export default function() {
    describe('02_MyAccount_Page', function () {

        const responses = http.batch([
            ['GET','https://ekaceluller.com/index.php?route=account/account',headers],
